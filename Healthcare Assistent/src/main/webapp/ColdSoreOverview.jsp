<%@page import="com.project.OverviewColdSore"%>
...
<title>Overview Page of Cold Sore</title>
</head>
<body>

<div class="box">
 <form id="form-form" action="ColdSoreSymptoms">
 <h1 class="hover-underline-animation"><a href = "ColdSoreOverview">Cold Sore</a></h1>
<h2>Overview :</h2>

	<% OverviewColdSore a = new OverviewColdSore(); %>
	<ul>
