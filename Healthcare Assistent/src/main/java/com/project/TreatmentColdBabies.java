...
public class TreatmentColdBabies {
	private String a;
	private String b;    
		
		public String Treatment1() throws IOException {

		    Document document = Jsoup.connect("https://www.mayoclinic.org/diseases-conditions/common-cold-in-babies/diagnosis-treatment/drc-20351657").timeout(6000).get();
		...
		public String Treatment12() throws IOException {
		...
		public String Treatment13() throws IOException {
		...
		public String Treatment14() throws IOException {
